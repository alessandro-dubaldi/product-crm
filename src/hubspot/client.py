...
Falls back to mock data automatically when HS_TOKEN is not set.
"""
from config.settings import HS_TOKEN

if not HS_TOKEN:
    from src.hubspot.mock_client import (  # noqa: F401
        fetch_active_companies,
        fetch_deals_for_company,
        fetch_contacts_for_deal,
    ...
    from config.settings import ACTIVE_DEAL_PIPELINE
